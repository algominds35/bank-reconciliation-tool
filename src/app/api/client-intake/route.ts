  ...
  try {
    ...
    const { data: client, error } = await supabase
      ...
      .insert([{
        ...
        ein: clientData.ein || null,
        year_established: clientData.yearEstablished || null,
        ...
        annual_revenue: clientData.annualRevenue || null,
        number_of_employees: clientData.numberOfEmployees || null,
        current_bookkeeper: clientData.currentBookkeeper || null,
        accounting_software: clientData.accountingSoftware || null,
        bank_accounts: clientData.bankAccounts || null,
        services_needed: clientData.servicesNeeded,
        frequency: clientData.frequency || null,
        start_date: clientData.startDate || null,
        special_requirements: clientData.specialRequirements || null,
        referral_source: clientData.referralSource || null,
...
<html>
<head>
    <title>Welcome to ReconcileBook Pro</title>
    <style>
