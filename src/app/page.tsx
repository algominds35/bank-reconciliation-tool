            ...
            <Card className="border-2 border-slate-200 bg-white shadow-lg hover:shadow-xl transition-all duration-500">
              <CardContent className="p-8">
                <div className="text-center">
                  ...
                  <a href="https://buy.stripe.com/3cI9AVe6i0ALcrfaee0Fi0a" target="_blank" rel="noopener noreferrer" className="w-full">
            ...
            <Card className="border-2 border-slate-200 bg-white shadow-lg hover:shadow-xl transition-all duration-500">
              <CardContent className="p-8">
                <div className="text-center">
                  ...
                  <a href="mailto:alex@usealgomind.com?subject=Enterprise%20Sales%20Inquiry&body=Hi,%0D%0A%0D%0AI'm%20interested%20in%20ReconcileBook%20Enterprise%20for%20my%20business.%0D%0A%0D%0ACompany:%20%0D%0AEmployees:%20%0D%0AMonthly%20Transactions:%20%0D%0A%0D%0APlease%20contact%20me%20to%20discuss%20pricing%20and%20implementation." className="w-full">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              <h3 className="text-2xl font-bold text-white mb-4">ReconcileBook</h3>
              <p className="text-slate-300 mb-6 max-w-md">
                The only bank reconciliation tool that actually works. Stop QuickBooks headaches and start getting results in minutes.
              </p>
              <div className="flex space-x-4">
                <a href="mailto:alex@usealgomind.com" className="text-slate-300 hover:text-white transition-colors">
            ...
            {/* Quick Links */}
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#demo-video" className="text-slate-300 hover:text-white transition-colors">Demo</a></li>
          ...
          <div className="border-t border-slate-800 mt-12 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6 mt-4 md:mt-0">
                <a href="mailto:alex@usealgomind.com" className="text-slate-400 hover:text-white text-sm transition-colors">
                  Contact: alex@usealgomind.com
                </a>
              </div>
            </div>
          </div>
